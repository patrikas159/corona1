...
public class Validation {
    ...
    public static final String EMAIL_REGEX_PATTERN="^[A-Za-z][0-9][@._-]\"{10,50}$";

    public static boolean isValidEmail(String email){
        Pattern pattern=Pattern.compile(EMAIL_REGEX_PATTERN);//Kuriamas sablonas pagal musu stringa
        Matcher matcher=pattern.matcher(email);//Palyginamas sablonas su vartotojo ivestais duomenimis
